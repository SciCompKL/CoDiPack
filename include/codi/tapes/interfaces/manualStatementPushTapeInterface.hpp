...
namespace codi {
  ...
  struct ManualStatementPushTapeInterface {
    public:
      ...
      using Real = CODI_DECLARE_DEFAULT(_Real, double); ///< See ManualStatementPushTapeInterface.
      using Gradient = CODI_DECLARE_DEFAULT(_Gradient, double); ///< See ManualStatementPushTapeInterface.
      using Identifier = CODI_DECLARE_DEFAULT(_Identifier, int); ///< See ManualStatementPushTapeInterface.
