...
namespace codi {
  ...
  struct JacobianBaseTape : public CommonTapeImplementation<T_TapeTypes, T_Impl> {
    public:
      ...
      using VectorAccess = AdjointVectorAccess<Real, Identifier, Adjoint, AdjointVector>;
    ...
    protected:
      ...
      template<typename Adjoint, typename AdjointVector>
      CODI_INLINE static void incrementAdjoints(AdjointVector adjointVector, Adjoint const& lhsAdjoint,
      ...
      template<typename Adjoint, typename AdjointVector>
      CODI_INLINE static void incrementTangents(AddToConst<AdjointVector> const adjointVector, Adjoint& lhsAdjoint,
                                                Config::ArgumentSize const& numberOfArguments, size_t& curJacobianPos,
                                                Real const* const rhsJacobians,
                                                Identifier const* const rhsIdentifiers) {
        size_t endJacobianPos = curJacobianPos + numberOfArguments;
    ...
    public:
      ...
      CODI_NO_INLINE void evaluate(Position const& start, Position const& end, AdjointVector data) {
        VectorAccess<Adjoint, AdjointVector> adjointWrapper(data);
        ...
        Wrap_internalEvaluateReverse_EvalStatements<Adjoint, AdjointVector> evalFunc;
      ...
      CODI_NO_INLINE void evaluateForward(Position const& start, Position const& end, AdjointVector data) {
        ...
        Wrap_internalEvaluateForward_EvalStatements<Adjoint, AdjointVector> evalFunc;
      ...
      VectorAccess<Gradient, decltype(adjoints.data())>* createVectorAccess() {
        return createVectorAccessCustomAdjoints<Gradient, decltype(adjoints.data())>(adjoints.data());
      }
      ...
      VectorAccess<Adjoint, AdjointVector>* createVectorAccessCustomAdjoints(AdjointVector data) {
        return new VectorAccess<Adjoint, AdjointVector>(data);
      }
      ...
      void evaluateForward(Position const& start, Position const& end,
        ...
        cast().template evaluateForward<Gradient, decltype(adjoints.data())>(start, end, adjoints.data());
      ...
      CODI_INLINE void evaluate(Position const& start, Position const& end,
        ...
        evaluate<Gradient, decltype(adjoints.data())>(start, end, adjoints.data());
