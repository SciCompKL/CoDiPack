...
namespace codi {
  ...
  /**
   * @brief Operation for empty expression.
   *
  ...
  struct EmptyOperation {
    public:
      ...
      using Real = CODI_DD(T_Real, double);  ///< See EmptyOperation.

      /// Zero value.
      static CODI_INLINE Real primal() {
        return Real();
      }
  ...
  using EmptyExpression = ComputeExpression<Real, EmptyOperation>;
}
