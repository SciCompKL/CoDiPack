 ...
 *
 * ComputeExpression<Real, ...> FUNCTION(ExpressionInterface<std::complex<Real>, Arg> const&);
 *
...
namespace codi {
  ...
  CODI_INLINE auto FUNCTION(ExpressionInterface<std::complex<Real>, Arg> const& arg) {
