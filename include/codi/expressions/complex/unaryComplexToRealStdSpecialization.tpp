 ...
 *
 * namespace std {
 *  codi::ComputeExpression<Real, ...> FUNCTION(complex<codi::ActiveType> const&);
 * }
 *
...
namespace std {
  ...
  CODI_INLINE auto FUNCTION(complex<codi::ActiveType<Tape>> const& arg) {
    return codi::ComputeExpression<typename Tape::Real, OPERATION_LOGIC, complex<codi::ActiveType<Tape>>>(arg);
  }
