 ...
 *
 * Prior to including this file, the user has to implement the operation's primal and derivative logic according to UnaryExtendedOpInterface.
 */
 ...
 *
 * @return UnaryExtendedOp instanciated for OPERATION_LOGIC.
 *
 * @tparam Real The real type used in the active types.
 * @tparam A The expression for the first argument of the function.
 */
template <typename Real, class A>
CODI_INLINE UnaryExtendedOp<Real, A, ARG_TYPE, OPERATION_LOGIC> FUNCTION(const Expression<Real, A>& a, ARG_TYPE b) {
  return UnaryExtendedOp<Real, A, ARG_TYPE, OPERATION_LOGIC>(a.cast(), b);
}
