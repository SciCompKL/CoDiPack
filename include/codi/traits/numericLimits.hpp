...
namespace std {
  ...
  struct numeric_limits<codi::ActiveType<Tape>> {
    ...
    public:
      ...
      static Type constexpr min() { return Type(numeric_limits<Passive>::min()); } ///< See numeric_limits
      static Type constexpr max() { return Type(numeric_limits<Passive>::max()); } ///< See numeric_limits
      static Type constexpr lowest() { return Type(numeric_limits<Passive>::lowest()); } ///< See numeric_limits
      ...
      static Type constexpr epsilon() { return Type(numeric_limits<Passive>::epsilon()); } ///< See numeric_limits
      static Type constexpr round_error() { return Type(numeric_limits<Passive>::round_error()); } ///< See numeric_limits
      ...
      static Type constexpr infinity() { return Type(numeric_limits<Passive>::infinity()); } ///< See numeric_limits
      static Type constexpr quiet_NaN() { return Type(numeric_limits<Passive>::quiet_NaN()); } ///< See numeric_limits
      static Type constexpr signaling_NaN() { return Type(numeric_limits<Passive>::signaling_NaN()); } ///< See numeric_limits
      static Type constexpr denorm_min() { return Type(numeric_limits<Passive>::denorm_min()); } ///< See numeric_limits
