...
void onStatementPrimal(Tape& tape, typename Tape::Real const& lhsValue, typename Tape::Identifier const& lhsIdentifier,
...
void registerForwardCallbacks() {
  codi::EventSystem<Tape>::registerStatementPrimalListener(onStatementPrimal);
}
